...
\renewcommand{\bibname}{Список литературы} % --- это для \documentclass{book} и ниже, типа, ``Литература''
\renewcommand{\refname}{Список литературы} % --- это для \documentclass{article} и ниже, типа, ``Источники''
